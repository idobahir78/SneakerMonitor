...
// Final safety check: If search term is still empty (even after load-last attempt), default to Nike
if (!RAW_SEARCH_INPUT || RAW_SEARCH_INPUT.trim() === '') {
    console.log("⚠️ Warning: No search term found (Load Last: " + shouldLoadLast + "). Defaulting to 'Nike'.".yellow.bold);
    RAW_SEARCH_INPUT = "Nike";
