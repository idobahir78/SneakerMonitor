...
class LimeShoesScraper extends BaseScraper {
    constructor(searchTerm) {
        ...
        if (!query) throw new Error("Search term is required for LimeShoesScraper");
        super('Lime Shoes', `https://limeshoes.co.il/?s=${encodeURIComponent(query)}&post_type=product`);
    }
        ...
        return await page.evaluate(() => {
            ...
            if (document.body.classList.contains('single-product')) {
                ...
                if (titleEl) {
                    ...
                    items.push({ store: 'Lime Shoes', title, price, link, sizes: [] });
                    return items;
                }
            }
